...
replace (
	github.com/pjbgf/sha1cd => github.com/pjbgf/sha1cd v0.2.3 // https://github.com/go-git/go-git/issues/624
	k8s.io/client-go => k8s.io/client-go v0.28.0-alpha.2 // https://github.com/kubernetes/client-go/issues/1084
)
