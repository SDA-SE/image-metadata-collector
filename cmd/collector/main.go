...
func newCommand() *cobra.Command {
	...
	c.PersistentFlags().StringVar(&imageNotificationRulesFlag, "image-notification-rules", "", "Ordered image notification rules as JSON array e.g. '[{\"image\":\"^ghcr\\\\.io/acme/private-app:.*$\",\"notifications\":{\"slack\":[\"#team-a\"],\"emails\":[\"team-a@example.com\"],\"ms_teams\":[\"team-a-channel\"]}}]'. First match wins and replaces existing notifications.")
